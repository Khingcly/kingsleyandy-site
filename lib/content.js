...
export const caseStudies = [
  {
    ...
    image: '/hse.png',
    imageAlt: 'Stylized illustration of the rebuilt HSE analytics dashboard with unified safety KPI indexes',
    oneLiner:
  ...
  },
  {
    ...
    image: '/tables150.png',
    imageAlt: 'Stylized illustration of ~150 fragmented reporting tables consolidated into one scalable data model',
    oneLiner:
  ...
  },
  {
    ...
    image: '/funnel.png',
    imageAlt: 'Stylized illustration of the automated marketing-to-sales funnel dashboard unifying six lead sources',
    oneLiner:
  ...
  },
  {
    ...
    image: '/hubspot.png',
    imageAlt: 'Stylized illustration of the management reporting dashboard migrated from HubSpot into Power BI',
    oneLiner:
  ...
  },
  {
    ...
    image: '/energy.png',
    imageAlt: 'Stylized illustration of the energy monitoring reporting dashboard migrated from Azure Data Explorer to SQL Server',
    oneLiner:
...
export const contact = {
  status: 'Open to opportunities: UK · US · UAE · Canada · remote or relocation',
